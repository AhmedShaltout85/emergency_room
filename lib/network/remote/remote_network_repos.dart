...
//53-- GET ALL APPROVAL NAMES(DROPDOWN-list)
  ...
  //55-- POST a new complaint(CREATE-COMPLAINT)
  Future<void> createNewComplaint({
    required String complaintAddress,
    required String gisLink,
    required String longitude,
    required String latitude,
    required String currentUsername,
    required String recipientName,
    required String recipientDestination,
    required String neighborhood,
    required String complaintSource,
    required String reporterName,
    required String reporterPhone,
    required String complaintRepairStatus,
    ...
    try {
      final response = await dio.post(
        'http://localhost:9999/pick-location/api/v1/complaints/create', // Update with your endpoint
        ...
        data: {
          ...
          "complaintRepairStatus": complaintRepairStatus,
          "approvalAuthority": approvalAuthority,
          "pumpDiameter": pumpDiameter,
          "seriousStatus": seriousStatus,
