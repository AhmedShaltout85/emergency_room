...
handleLinkAsInformant(
  ...
  Function refreshCallback) 
 {
  ...
  final currentRepeatComplaintNumber = item['repeatComplaintNumber']?.toString() ?? '0';
  final complaintNote = item['complaintNote']?.toString() ?? '';

  context.showUpdateComplaintDialog(
    id: complaintId,
    currentValue: currentRepeatComplaintNumber,
    valueLabel: 'رقم البلاغ',
    dialogTitle: 'تحديث  رقم البلاغ المكرر',
    ...
    onUpdate: (newValue) async {
      try {
        ...
        await DioNetworkRepos().updateComplaintByIdAndRepeatComplaintNumber(
          complaintId,
          newValue,
        );
        ...
        _showSuccessSnackbar(context,
            '✅ تم تحديث الربط كمكرر للبلاغ رقم $complaintId من $currentRepeatComplaintNumber إلى $newValue');
...
void _handleError(BuildContext context, dynamic error, String complaintId) {
  String errorMessage = '❌ فشل تحديث حالة الربط كمكرر';
